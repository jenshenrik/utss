...
public class SoundEffectSO : ScriptableObject
{
    ...
    [Tooltip(@"The minimum pitch variation for the sound effect. A random pitch variation will be generated between 
        the minimum and maximum values. A random pitch variation makes sound effects sound more natural.")]
    [Range(0.1f, 1.5f)]
    public float soundEffectPitchRandomVariationMin = 0.8f;

    [Tooltip(@"The maximum pitch variation for the sound effect. A random pitch variation will be generated between 
        the minimum and maximum values. A random pitch variation makes sound effects sound more natural.")]
    [Range(0.1f, 1.5f)]
